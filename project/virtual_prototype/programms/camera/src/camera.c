...
//   while(1) {
//     takeSingleImageBlocking((uint32_t) &camOut[0]);
//     floyd_steinberg(camOut, camParams.nrOfPixelsPerLine, camParams.nrOfLinesPerImage, floyd, error_array);
//     edgeDetection(floyd, grayscale, camParams.nrOfPixelsPerLine, camParams.nrOfLinesPerImage, 200);
